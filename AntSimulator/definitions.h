...
static unsigned int ___LARVA_TRANSFORM_TIME___ = 5;
static unsigned int ___MAX_TRANSFORM_COUNT___ = 3;
static unsigned int ___ADULTHOOD___ = 7;
static unsigned int ___MIN_FERTILITY___ = 3;
static unsigned int ___ANT_MAX_HEALTH___ = 5;